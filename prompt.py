...
BIOMEDCOOP_TEMPLATES = {
    ...
    "normal liver": [
    "A normal liver on ultrasound shows a smooth, uninterrupted capsule with homogeneous parenchymal echotexture",
    "The hepatic echogenicity is uniform, without focal hyperechoic or hypoechoic lesions",
    "Portal and hepatic veins are clearly patent and run through a uniformly echogenic background",
    "There is no evidence of surface nodularity or lobar contour irregularity",
    "In B‑mode imaging the liver‑to‑kidney echo ratio remains within normal limits",
    "Color Doppler demonstrates antegrade flow in the main portal vein without turbulence",
    "The intrahepatic biliary ducts are not dilated and measure less than 2 mm in diameter",
    "Shear‑wave elastography values fall within the normal range, excluding significant fibrosis",
    "No focal lesions, cysts, or calcifications are detected on survey ultrasound",
    "Hepatic surface is smooth with continuous, thin echogenic line of the capsule",
    "On non‑contrast CT, the liver demonstrates homogeneous attenuation of 55 ± 10 HU",
    "Liver density is slightly greater than that of the spleen on unenhanced CT",
    "No focal low‑attenuation or high‑attenuation lesions are seen in the parenchyma",
    "Liver contour is smooth without capsular retraction or bulging",
    "During portal venous phase, the parenchyma enhances uniformly without perfusion defects",
    "Hepatic veins and portal vein branches are well‑opacified and free of thrombus",
    "No evidence of transient hepatic attenuation differences (THAD) in the arterial phase",
    "In equilibrium phase, the liver maintains consistent enhancement without washout",
    "No biliary dilatation seen on CT‐based hepatobiliary imaging",
    "Liver volume falls within normal reference ranges for patient’s body habitus",
    "T1‑weighted MRI shows homogeneous signal intensity equal to or slightly higher than muscle",
    "T2‑weighted MRI demonstrates low to intermediate, even signal throughout the parenchyma",
    "No focal signal voids or high‑signal foci on out‑of‑phase sequences",
    "In diffusion‑weighted imaging (DWI), there is no restricted diffusion",
    "Dynamic contrast‑enhanced MRI reveals homogeneous arterial, portal, and equilibrium phase enhancement",
    "No visible hepatic masses or nodules on high‑resolution T1‑ or T2‑weighted sequences",
    "The liver capsule appears smooth and sharply demarcated on all MRI sequences",
    "MRCP images show normal caliber biliary ducts without obstruction or irregularity",
    "Susceptibility‑weighted/GRE sequences reveal no areas of iron overload",
    "Hepatic arterial, portal venous, and hepatic venous phases all show consistent signal without perfusion anomalies",
    "On in‑phase and out‑of‑phase imaging, there is no evidence of microscopic fat deposition :contentReferunce[oaicite:30]{index=30}",
    "No capsular retraction or pseudocapsule formation is observed",
    "The ligamentum teres and falciform ligament are seen normally without adjacent parenchymal changes",
    "No periportal edema or periportal cuffing on T2‑weighted images",
    "Liver stiffness measured by MR elastography falls within normal limits",
    "No perihepatic fluid collections or ascites are present",
    "Inferior vena cava and hepatic veins show normal flow dynamics on phase‑contrast MRI",
    "No evidence of focal fatty sparing or focal fatty infiltration",
    "The gallbladder appears normal in size with thin wall and no stones",
    "Common bile duct measures less than 6 mm with smooth margins",
    "Lymph nodes in the porta hepatis region are not enlarged",
    "No perivascular fat stranding or inflammatory changes",
    "Overall imaging demonstrates a normal‐appearing liver free of pathology",
    "On ultrasound, the liver capsule appears smooth with a homogeneous parenchymal echotexture and no focal lesions",
    "Portal and hepatic veins are patent and clearly visualized within uniformly echogenic hepatic tissue on B‑mode imaging",
    "Non‑contrast CT shows homogeneous hepatic attenuation of approximately 55 ± 10 HU without any low‑ or high‑density foci",
    "During the portal venous phase on contrast CT, the liver enhances uniformly without perfusion defects or transient attenuation differences",
    "T1‑weighted MRI demonstrates even signal intensity throughout the parenchyma with no measurable signal drop on out‑of‑phase sequences",
    "On diffusion‑weighted imaging (DWI), there is absence of restricted diffusion, indicating no acute pathology",
    "MRCP shows normal caliber intrahepatic and extrahepatic bile ducts without evidence of obstruction or irregularity"
  ]  ,
  "liver tumor":[
    "A liver tumor appears as a focal, well‑circumscribed hypoechoic lesion on ultrasound.",
    "On ultrasound, the mass exhibits heterogeneous echotexture with intermixed hyperechoic and hypoechoic areas.",
    "Color Doppler ultrasound may show internal vascular flow within the lesion, reflecting neovascularization.",
    "Ultrasound often reveals irregular or lobulated margins with posterior acoustic enhancement.",
    "On non‑contrast CT, liver tumors typically present as hypoattenuating focal lesions against normal parenchyma.",
    "During the arterial phase of contrast‑enhanced CT, hypervascular tumors exhibit intense early enhancement.",
    "A washout appearance in the portal venous phase on CT is characteristic of hepatocellular carcinoma.",
    "CT may demonstrate central areas of low attenuation due to necrosis or cystic degeneration.",
    "Peripheral nodular enhancement with progressive centripetal fill‑in on CT suggests a hemangioma.",
    "Contrast‑enhanced CT can show a smooth, thin pseudocapsule around malignant liver masses.",
    "Calcifications within a liver tumor, visible on CT, may indicate metastasis or slow‑growing neoplasms.",
    "On dynamic MRI, many malignant lesions show arterial phase hyperenhancement followed by washout.",
    "T1‑weighted MRI typically shows liver tumors as hypointense relative to normal liver tissue.",
    "On T2‑weighted MRI, most tumors appear hyperintense due to increased water content and edema.",
    "Hemorrhagic tumors demonstrate areas of high signal on T1‑weighted MRI from blood products.",
    "A central scar with delayed enhancement on MRI is a hallmark of focal nodular hyperplasia.",
    "Diffusion‑weighted imaging (DWI) often reveals restricted diffusion in malignant lesions.",
    "A low apparent diffusion coefficient (ADC) on MRI correlates with high cellularity in tumors.",
    "Gadolinium‑enhanced MRI can depict a hypointense rim—representing a fibrous capsule—around tumors.",
    "Peritumoral enhancement on MRI may reflect adjacent inflammatory changes.",
    "Contrast‑enhanced ultrasound (CEUS) provides real‑time arterial hyperenhancement visualization.",
    "Rapid washout on CEUS helps distinguish malignant lesions from benign vascular tumors.",
    "CEUS can differentiate hemangiomas by their characteristic peripheral nodular enhancement pattern.",
    "Large tumors may displace adjacent vascular structures, indicating a space‑occupying effect.",
    "Tumor invasion of portal or hepatic veins on imaging signifies advanced disease.",
    "Satellite nodules around a primary lesion on imaging suggest intrahepatic metastases.",
    "Capsular retraction overlying a liver tumor reflects a desmoplastic response.",
    "In‑phase and out‑of‑phase MRI sequences detect intratumoral fat within adenomas.",
    "Hepatobiliary phase MRI with liver‑specific contrast agents shows lesion uptake patterns.",
    "Lesions lacking uptake in the hepatobiliary phase appear hypointense compared to liver.",
    "MRI perfusion imaging quantifies vascularity through time‑signal intensity curves.",
    "On PET‑CT, malignant liver tumors often demonstrate increased FDG uptake.",
    "Hypermetabolism on PET‑CT correlates with aggressive tumor biology.",
    "Dual‑energy CT can characterize lesion composition via material decomposition maps.",
    "Enhancement ratios on CT (pre‑ vs. post‑contrast HU) help quantify tumor vascularity.",
    "A pseudocapsule sign on CT arises from compressed parenchyma around the lesion.",
    "Intratumoral fat, seen as low attenuation on CT, suggests certain tumor subtypes.",
    "Fibrolamellar carcinoma often presents as a large, heterogeneously enhancing mass.",
    "Cholangiocarcinoma typically shows progressive delayed enhancement due to fibrous stroma.",
    "Dynamic multiphasic imaging distinguishes tumors by their unique enhancement kinetics.",
    "A lobulated tumor contour on imaging raises suspicion for malignancy over benign lesions.",
    "Heterogeneous imaging appearance often corresponds to necrosis, hemorrhage, or fibrosis.",
    "Rim enhancement with central necrosis on CT is suggestive of metastatic disease.",
    "A targetoid appearance—concentric zones of enhancement—is frequently seen in metastases.",
    "Washout timing differentiates benign from malignant lesions in multiphasic studies.",
    "An enhancing capsule and washout pattern are key features in LI‑RADS for HCC.",
    "Tumor grading and staging rely on multiphasic imaging to assess size and vascular involvement.",
    "On gadoxetic acid–enhanced MRI, malignant liver tumors typically appear hypointense on the hepatobiliary phase due to impaired uptake by nonfunctional hepatocytes",
    "Contrast‑enhanced ultrasound often demonstrates early arterial hyperenhancement followed by washout in the late phase in malignant liver tumors",
    "On FDG PET‑CT, liver tumors usually exhibit increased metabolic activity, appearing as areas of hypermetabolism relative to normal liver tissue"
    ] ,
  "normal retina": [],
  "retinal edema": [],
  "normal chest x-ray": [],
