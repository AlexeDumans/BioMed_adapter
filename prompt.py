...
"normal liver": [
    "Homogeneous parenchymal attenuation measuring approximately 55 HU on non‑contrast CT.",
    "Smooth, well‑defined hepatic capsule with sharp contours abutting the diaphragm.",
    "Uniform parenchymal enhancement during the portal venous phase (~70–80 s post‑contrast).",
    "Clear visualization of hepatic veins converging towards the IVC with consistent luminal attenuation.",
    "Preserved Couinaud segmentation, demarcated by portal and hepatic vein landmarks.",
    "Absence of focal lesions, cysts, or masses within the liver parenchyma.",
    "No fatty infiltration: parenchymal attenuation not measurably lower than spleen on non‑contrast CT.",
    "Caudate-to-right-lobe volume ratio < 0.6, consistent with non‑cirrhotic normal.",
    "Intrahepatic bile ducts not dilated, measuring ≤ 2 mm centrally and tapering peripherally.",
    "Common bile duct ≤ 6–7 mm in diameter in adults without cholecystectomy.",
    "Portal vein diameter 7–13 mm on axial CT.",
    "Liver parenchyma 5–10 HU denser than spleen on unenhanced CT.",
    "No calcifications or hemorrhagic foci within the liver parenchyma.",
    "No periportal low‑attenuation halos around portal branches (absent periportal halo sign).",
    "Hepatic veins ~ 5.6–6.2 mm in diameter with smooth luminal contours.",
    "IVC diameter at hepatic level 12–17 mm.",
    "Minimal enhancement in early arterial phase (15–20 s).",
    "Progressive homogeneous enhancement in late arterial phase (35–40 s) with still minimal portal vein opacification.",
    "Maximal homogeneous enhancement of parenchyma on portal venous phase (~75 s).",
    "Equilibrium phase (3–10 min) shows uniform slight washout without focal retention.",
    "No hepatic capsular retraction; normal convex liver surface.",
    "Subcapsular space devoid of fluid or blood; capsule itself not distinctly visible on CT.",
    "Uniform parenchymal texture without focal fatty sparing or deposition.",
    "Absence of subcapsular hematoma or fluid collections.",
    "No ascites or perihepatic fluid on CT.",
    "Visible falciform ligament and ligamentum teres without calcification.",
    "Bare area smoothly rounded, without irregularity or adherent tissue.",
    "Normal lobar dimensions: craniocaudal length 10–12.5 cm; transverse diameter 20–23 cm.",
    "Smooth visceral surface with physiologic impressions of adjacent organs.",
    "No transient hepatic attenuation differences (THAD) on arterial phase.",
    "No arterioportal shunts; uniform perfusion.",
    "No hepatic abscess pockets or gas.",
    "Parenchyma isoattenuating to muscle on non‑contrast CT (55–65 HU).",
    "No perirenal fat stranding in hepatorenal recess.",
    "Uniform liver–kidney interface; no mass effect.",
    "Biliary tree minimally seen: intrahepatic ducts faint, non‑dilated.",
    "Portal triad structures branch normally without focal enlargement.",
    "No collateral veins or varices suggestive of portal hypertension.",
    "No capsular calcifications or surface nodularity.",
    "Even washout kinetics matching normal liver parenchyma in delayed phase.",
    "No hyperattenuating regenerating nodules.",
    "Parenchyma remains homogeneous on equilibrium phase.",
    "All eight liver segments visible with normal thickness and attenuation.",
    "No parenchymal heterogeneity on any phase.",
    "Uniform perivascular fat without streaking.",
    "No peritoneal metastases or surface nodules.",
    "No abnormal enhancement along peritoneal ligaments.",
    "Homogeneous appearance across all lobes; no relative hyper‑ or hypoattenuation.",
    "Uniform venous‑phase attenuation in anterior, posterior, and caudate lobes.",
    "No capsular dimpling or collapse sign indicating underlying lesion."
  ],
  "liver tumor":[
    "Peripheral discontinuous nodular enhancement in arterial phase with progressive centripetal fill‑in.",
    "Hypodense on non‑contrast CT, matching vascular pool density on all post‑contrast phases.",
    "Flash‑filling in small hemangiomas: homogeneous arterial phase enhancement without nodular pattern.",
    "Persistent hyperdensity in delayed phase equal to blood vessels.",
    "Isoattenuation to aorta in arterial and portal phases.",
    "Intense homogeneous arterial‑phase hyperenhancement sparing a central stellate scar.",
    "Central scar hypodense on arterial phase, enhancing on delayed imaging.",
    "Radiating fibrous septa (“orange‑slice” appearance) dividing nodules.",
    "Iso‑ or hypoattenuating on portal venous and delayed phases without wash‑out.",
    "Absence of a true capsule and no capsular retraction.",
    "Well‑circumscribed mass with heterogeneous arterial enhancement.",
    "Rapid wash‑out in portal venous and delayed phases.",
    "Intralesional hypoattenuating areas from necrosis or hemorrhage.",
    "Intratumoral fat causing heterogeneous low attenuation.",
    "Hypervascular arterial phase without a pseudocapsule.",
    "Arterial phase hyperenhancement relative to liver.",
    "Wash‑out in portal venous and delayed phases.",
    "Enhancing pseudocapsule in delayed phases.",
    "Internal mosaic architecture with septa and necrosis.",
    "Tumor thrombus in portal vein showing arterial enhancement and wash‑out.",
    "Peritumoral arterial hyperenhancement from arterioportal shunting.",
    "Central necrosis with irregular hypoattenuating core.",
    "Fat‑containing HCC: intratumoral fat low‑density on non‑contrast.",
    "Rapid interval growth > 50% in < 6 months.",
    "Peripheral thin rim enhancement in arterial phase (“rim‑enhancing”).",
    "Progressive centripetal enhancement in portal venous and delayed phases.",
    "Capsular retraction adjacent to tumor.",
    "Upstream biliary dilation proximal to lesion.",
    "Central fibrous stroma hypoattenuating early, hyperattenuating delayed.",
    "Satellite nodules around main mass.",
    "Vascular encasement or invasion of portal/hepatic veins.",
    "Segmental liver atrophy in involved area.",
    "Hypoattenuating on non‑contrast, peripheral rim enhancement arterial.",
    "Fill‑in with persistent rim on portal venous and wash‑out delayed.",
    "Target sign: central necrosis with peripheral ring enhancement.",
    "Calcifications post‑chemotherapy.",
    "Early arterial hyperenhancement (hypervascular metastases).",
    "Rapid wash‑out on portal venous phase (hypervascular metastases).",
    "Rim enhancement with central necrosis delayed (hypervascular metastases).",
    "Homogeneous hypoattenuating masses with minimal contrast enhancement.",
    "Faint peripheral rim enhancement sometimes.",
    "Periportal soft‑tissue thickening (“periportal cuffing”).",
    "Persistent low attenuation without wash‑out.",
    "Target‑like rim enhancement in primary lymphoma.",
    "Multiple heterogeneous hypoattenuating masses, some hyperattenuating hemorrhage.",
    "Progressive but incomplete enhancement nodular or flame‑shaped.",
    "Areas of hemorrhage and necrosis hyperdense on non‑contrast.",
    "Multifocal lesions with variable size and capsular retraction.",
    "Peripheral subcapsular distribution of multiple hypoattenuating nodules.",
    "Lollipop sign: vessel branch tapering and terminating at lesion edge."
    ] ,

  "normal retina": [
    "Continuous, smooth hyperreflective line of the internal limiting membrane (ILM) demarcating vitreoretinal interface.",
    "Uniform, moderately hyperreflective retinal nerve fiber layer (RNFL) immediately beneath the ILM.",
    "Distinct hyporeflective band of the ganglion cell layer (GCL) separating RNFL from inner plexiform layer (IPL).",
    "Homogeneous, hyperreflective inner plexiform layer (IPL) with consistent thickness across scan.",
    "Well‑defined, hyporeflective inner nuclear layer (INL) beneath the IPL.",
    "Uniform hyperreflective band of the outer plexiform layer (OPL) adjacent to the INL.",
    "Consistent hyporeflective outer nuclear layer (ONL) under the OPL, without cystic spaces.",
    "Thin, continuous hyperreflective external limiting membrane (ELM) between ONL and photoreceptors.",
    "Distinct, bright ellipsoid zone (photoreceptor inner segment/outer segment junction) band.",
    "Continuous interdigitation zone (photoreceptor outer segment tips) just below the ellipsoid zone.",
    "Sharp, hyperreflective line of the retinal pigment epithelium (RPE)–Bruch’s membrane complex.",
    "Uniform thickness and reflectivity of RPE without irregular elevations or detachments.",
    "Smooth contour of the foveal pit with a clear excavation of inner retinal layers.",
    "Symmetrical slopes of the foveal pit on nasal and temporal sides.",
    "Minimum central subfield thickness (CST) of approximately 250 µm at the foveal center.",
    "Parafoveal retinal thickness gradually increasing from the fovea to perifovea.",
    "No intraretinal hyporeflective cystoid spaces or fluid pockets.",
    "Absence of subretinal hyporeflective fluid between photoreceptors and RPE.",
    "Clear vitreoretinal interface without epiretinal membrane or traction.",
    "Posterior hyaloid membrane not adherent to macula (no vitreomacular adhesion).",
    "Homogeneous signal strength across scan without shadowing artifacts.",
    "No hyperreflective foci or deposits within any retinal layer.",
    "Uniform choriocapillaris band beneath RPE–Bruch’s complex.",
    "Gradual transition from Sattler’s to Haller’s layer in the choroid, visible below RPE.",
    "Choroidal thickness under the fovea between 200–300 µm in healthy adults.",
    "Clear delineation of sclerochoroidal interface without irregularity.",
    "No focal elevations or drusen-like bumps at the RPE level.",
    "Healthy macular microstructure: intact outer retinal bands without disruption.",
    "Absence of pigment epithelial detachment or sub‑RPE fluid.",
    "Regular reflectivity profile in an A‑scan trace with identifiable peaks for each layer.",
    "No shadowing or signal dropout under retinal vessels.",
    "Absence of hyperreflective deposits in Henle’s fiber layer.",
    "Uniform reflectivity of the nerve fiber layer across macula.",
    "No retinal thinning or focal atrophy in parafoveal regions.",
    "Intact external retinal layers without signs of ellipsoid zone disruption.",
    "Smooth transition from inner to outer retina at the foveal edge.",
    "Clear visualization of the foveal avascular zone outline on adjacent OCTA scan.",
    "No evidence of microcystic spaces in the inner nuclear layer.",
    "Consistent segmentation of all retinal layers by automated software without errors.",
    "Absence of sub‑ILM or subhyaloid hemorrhage.",
    "Retinal thickness maps show central–parafoveal pattern typical of normals.",
    "No hyperreflective epiretinal membranes on en face OCT projections.",
    "Uniform attenuation coefficient throughout retinal thickness.",
    "No outer retinal tubulation or cavitation.",
    "RPE–Bruch’s complex appears flat without undulations.",
    "No signs of choroidal neovascular membranes beneath RPE.",
    "Vitreous chamber free of opacities or reflective interfaces.",
    "Foveal depression depth and width within normative database limits.",
    "Automated segmentation lines align accurately with each hyper/hyporeflective band.",
    "Lamina cribrosa and optic nerve head contours spared in macular scan.",
    "No peripapillary atrophy extending into macular region."],
  "retinal edema": [
    "Increased central subfield thickness (> 300 µm) with loss of foveal depression.",
    "Diffuse retinal thickening exhibiting a sponge‑like appearance with uniform hyporeflective spaces.",
    "Multiple intraretinal hyporeflective cystoid spaces in the inner nuclear and outer plexiform layers.",
    "Petaloid configuration of cystoid spaces radiating from the foveal center.",
    "Honeycomb pattern of microcystic changes in the inner nuclear layer.",
    "Hyporeflective cystoid cavities separated by hyperreflective septa corresponding to Müller cell processes.",
    "Backshadowing beneath large cystoid spaces due to overlying reflective septa.",
    "Disruption or attenuation of the ellipsoid zone adjacent to cystoid spaces.",
    "Elevation and irregularity of the external limiting membrane over fluid collections.",
    "Hyporeflective subretinal fluid pocket between the neurosensory retina and RPE.",
    "Dome‑shaped smooth detachment of the neurosensory retina from the RPE.",
    "Presence of hyperreflective foci within the retina corresponding to lipid exudates.",
    "Hyperreflective dots casting discrete shadows on deeper layers indicating hard exudates.",
    "Microaneurysms appearing as hyperreflective walls with hyporeflective lumen.",
    "Vitreomacular traction evidenced by thickened hyperreflective posterior hyaloid face.",
    "Focal retinal surface wrinkling caused by epiretinal membrane associated with edema.",
    "Loss of definition between inner retinal layers indicating disorganization of retinal inner layers (DRIL).",
    "Reduced reflectivity and blurring of boundaries between RNFL, GCL, IPL, and INL.",
    "Increased reflectivity in the Henle fiber layer around cystoid spaces.",
    "Bridging hyperreflective columns spanning across intraretinal cysts (Müller cell columns).",
    "Champagne‑bubbling sign: numerous tiny cysts creating a bubbly retinal appearance.",
    "Sponge sign: dark hyporeflective regions in OPL with intervening hyperreflective septa.",
    "Inverted mushroom‑shaped cystoid cavities suggestive of chronic cystoid macular edema.",
    "Progressive merging of adjacent cysts forming larger vacuoles in longstanding edema.",
    "Sub‑ILM pseudocyst formation appearing as a hyperreflective dome beneath ILM.",
    "Temporal parafoveal shallow detachment forming subretinal fluid in macular edema.",
    "Retinal thickening maps showing diffuse thickness across parafoveal quadrants.",
    "Absence of normal foveal pit contour with flattening of the foveal depression.",
    "Increased outer nuclear layer thickness in parafoveal regions.",
    "Irregular widening of the OPL due to intraretinal fluid accumulation.",
    "Hyperreflective bridging tissue indicating glial proliferation in chronic edema.",
    "Persistent backshadowing under drusen‑like hard deposits in macular edema.",
    "Subretinal hyperreflective deposits indicating chronic exudation beneath photoreceptors.",
    "Presence of SRF with septations causing multilobulated subretinal spaces.",
    "Choroidal thickness remains normal despite pronounced retinal edema.",
    "Choroidal‑scleral interface preserved without irregularities.",
    "No significant change in RPE–Bruch’s complex except mild undulations.",
    "ERMs appear as hyperreflective membranes adherent to the ILM causing distortion.",
    "Tractional retinoschisis‑like splits in inner retina due to vitreoretinal traction.",
    "Foveal avascular zone enlargement seen on OCTA overlay correlating with edema.",
    "Optic disc edema with peripapillary fluid cuff in papilledema spectrum.",
    "Peripapillary subretinal fluid in optic disc swelling cases.",
    "Cystic spaces adjacent to optic disc margin in papilledema.",
    "Uveitic macular edema shows diffuse intraretinal fluid with inflammatory hyperreflective spots.",
    "Serpiginous patterns of fluid pockets in chronic uveitic edema.",
    "Subfoveal neurosensory detachment accompanying cystoid changes.",
    "Temporal retina shows granular hyperreflective deposits from inflammatory cells.",
    "Persistent vitreous hyperreflective bands indicating vitreomacular traction.",
    "Disruption of the ELM correlates with poor visual acuity prognosis.",
    "Reflectivity profile shows multiple peaks with diminished troughs across retinal depth."
    ],
  "normal chest x-ray": [
"Adequate inspiration judged by visualization of 9–10 posterior ribs above the diaphragm at the mid‑scapular line.",
    "Proper exposure with faint visualization of thoracic vertebrae through the cardiac silhouette.",
    "No patient rotation indicated by symmetric medial ends of the clavicles equidistant from the spinous processes.",
    "Trachea midline without deviation or narrowing.",
    "Carina situated at the level of the fifth thoracic vertebra.",
    "Bilateral lung fields clear without focal opacities or consolidations.",
    "Normal vascular markings tapering peripherally, not extending beyond the lung periphery.",
    "No areas of increased opacity suggesting consolidation or interstitial patterns.",
    "Sharp costophrenic angles with no blunting.",
    "Cardiothoracic ratio less than 0.5 on a PA film.",
    "Smooth contour of the aortic knob without abnormal prominence.",
    "Right descending pulmonary artery diameter within normal limits (< 16 mm in men, < 15 mm in women).",
    "Hilar regions symmetrical and normal in size without enlargement.",
    "Lobar fissures either invisible or faint, with the minor fissure occasionally seen at the level of the 5th–6th rib.",
    "Right hemidiaphragm positioned slightly higher than the left by one intercostal space.",
    "Gastric air bubble visible beneath the left hemidiaphragm.",
    "Mediastinal width normal (less than one‑third of the thoracic width on PA view).",
    "Superior mediastinum smooth without widening or masses.",
    "Retrosternal clear space preserved on the lateral projection.",
    "Thoracic vertebral endplates visible through the spine shadow.",
    "Intact bony structures: ribs, clavicles, scapulae, and vertebrae without fractures or lytic/sclerotic lesions.",
    "Symmetric clavicles and sternoclavicular joints.",
    "Scapular outlines lying lateral to the lung fields on PA projection (not projecting over lungs).",
    "Soft tissues of chest wall without subcutaneous emphysema or masses.",
    "Breast shadows symmetric, without masses or asymmetry.",
    "Azygoesophageal recess clear and sharply marginated on lateral film.",
    "Negative silhouette signs: sharp borders between heart, aorta, and adjacent lung.",
    "No pleural thickening or plaques.",
    "No pleural effusion: costophrenic angles remain acute.",
    "No pneumothorax: lung edges abut the chest wall without extrapulmonary air.",
    "Retrocardiac clear space without obscuration.",
    "No signs of hyperinflation: diaphragms domed and not flattened.",
    "No interstitial markings such as Kerley B lines.",
    "No nodular opacities or masses.",
    "No intrapulmonary calcifications.",
    "Normal upper abdominal silhouettes: liver shadow under right hemidiaphragm.",
    "Minor bowel gas pattern seen under left hemidiaphragm.",
    "First rib margins and clavicular heads visible.",
    "No central lines, endotracheal tubes, or other medical devices.",
    "Tracheobronchial tree patency without sudden cutoff.",
    "No mediastinal shift or deviation.",
    "No widening of the mediastinum.",
    "Clear aortopulmonary window without soft tissue opacity.",
    "Normal thoracic spine alignment and disc spaces.",
    "No scapular winging or abnormal scapulothoracic relationships.",
    "Even lung lucency without focal hyperlucent areas.",
    "No evidence of interlobular septal thickening.",
    "No pericardial effusion: clear pericardial silhouette.",
    "No evidence of diaphragmatic hernia or eventration.",
    "Symmetric costovertebral angles with no pleural plaques."
    ],
  "thoracic abnormlaity": [
    "Visible thin, sharp white line of visceral pleura with absent peripheral lung markings indicating pneumothorax. ",
    "Blunting of costophrenic angle with meniscus‑shaped opacity in dependent pleural space denoting pleural effusion. ",
    "Air‑bronchograms: air‑filled bronchi within homogeneous opacity characteristic of pulmonary consolidation. ",
    "Kerley B lines: short horizontal septal lines at lung periphery indicating interstitial pulmonary edema. ",
    "Diffuse hazy perihilar “bat‑wing” pattern of alveolar edema on chest X‑ray. ",
    "Flattened diaphragms with increased retrosternal airspace signifying lung hyperinflation in emphysema. ",
    "Increased cardiothoracic ratio > 0.5 on PA film consistent with cardiomegaly. ",
    "Widened superior mediastinum > 8 cm on PA view suggesting mediastinal widening. ",
    "Discrete coin‑shaped calcified pulmonary nodule (granuloma) with dense central calcification. ",
    "Numerous tiny nodules in random distribution indicating miliary tuberculosis. ",
    "Lucent streaks of air outlining mediastinal structures denoting pneumomediastinum. ",
    "Elevated hemidiaphragm with ipsilateral lung volume loss indicating phrenic nerve palsy. ",
    "Mediastinal shift toward opacity with signs of volume loss characteristic of atelectasis. ",
    "Mediastinal shift away from hyperlucent hemithorax denoting tension pneumothorax. ",
    "Subcutaneous emphysema: streaky lucencies in soft tissues of chest wall. ",
    "Surgical sternotomy wires visible over mediastinum. ",
    "Clavicular or sternal fixation hardware observed post‑surgery. ",
    "Endotracheal tube tip 3–5 cm above carina confirming proper placement. ",
    "Central venous catheter tip at the cavoatrial junction on chest X‑ray. ",
    "Nasogastric tube coursing midline into stomach below diaphragm. ",
    "Unilateral hyperlucency from endobronchial intubation showing one‑sided overinflation. ",
    "Step‑off cortical discontinuity of rib shaft with adjacent soft‑tissue swelling in rib fracture. ",
    "Multiple displaced segmental rib fractures defining flail chest segment. ",
    "Lateral curvature and rotation of thoracic spine indicating scoliosis. ",
    "Inward depression of sternum with reduced AP diameter in pectus excavatum. ",
    "Outward protrusion of sternum suggestive of pectus carinatum. ",
    "Air‑fluid level with bowel gas pattern above diaphragm in diaphragmatic hernia. ",
    "Retrocardiac air‑fluid level in hiatus hernia on PA chest X‑ray. ",
    "Silhouette sign: loss of right heart border in right middle lobe pneumonia. ",
    "Sail sign: triangular opacity obscuring right upper lung field in right upper lobe collapse. ",
    "Triangular opacity at lung base with blunted ipsilateral costophrenic angle in lower lobe collapse. ",
    "Homogeneous opacity with slight volume expansion differentiating consolidation from collapse. ",
    "Peripheral wedge‑shaped pleural‑based opacity (Hampton’s hump) suggestive of pulmonary infarct. ",
    "Focal oligemia (Westermark sign) showing regional hyperlucency in pulmonary embolism. ",
    "Enlarged hilar vessels with pruning of peripheral vasculature indicating pulmonary hypertension. ",
    "Widened paratracheal stripe denoting mediastinal lymphadenopathy. ",
    "Reticulonodular pattern of small interstitial lines and nodules in interstitial lung disease. ",
    "Crazy‑paving pattern: scattered ground‑glass opacities with superimposed interlobular septal thickening in pulmonary alveolar proteinosis. ",
    "Peripheral pleural plaques with calcification on chest wall mesothelioma. ",
    "Round pneumonia presenting as a solitary, well‑demarcated round opacity with air bronchograms. ",
    "Multiple ring‑enhancing nodules with central lucency suggesting cavitating metastases. ",
    "Peribronchial cuffing: thickened bronchial walls creating “doughnut” shadows around bronchi. ",
    "Bronchiectasis: tram‑track lines and ring shadows representing thickened dilated bronchi. ",
    "Pulmonary alveolar proteinosis – bat‑wing ground‑glass opacities on chest X‑ray. ",
    "Mediastinal lymphadenopathy – enlarged lymph nodes obscuring normal mediastinal contours. ",
    "Mediastinal calcification in healed granulomatous disease outlining aortic knob. ",
    "Coal worker’s pneumoconiosis: upper‑lobe nodular opacities with progressive massive fibrosis. ",
    "Asymmetric lung hyperlucency with mediastinal shift in unilateral bullous emphysema. ",
    "Free air under diaphragm on erect chest X‑ray indicating pneumoperitoneum. ",
    "Air trapping on expiratory film: areas of retained lucency signifying small airway disease. ",
    "Subcutaneous emphysema outlining pectoral muscles as lucent streaks in soft tissue. "
 
    ],
  "retinal pathology": [
    "Increased central subfield thickness (> 300 µm) with loss of foveal depression. ",
    "Diffuse retinal thickening with sponge‑like hyporeflective spaces. ",
    "Intraretinal hyporeflective cystoid spaces in the inner nuclear and outer plexiform layers. ",
    "Petaloid configuration of cystoid spaces radiating from the foveal center. ",
    "Hyperreflective foci (lipid exudates) within the retina casting shadows on deeper layers. ",
    "Backshadowing beneath large cystoid spaces due to overlying reflective septa. ",
    "Disorganization of retinal inner layers (DRIL): loss of clear boundaries between RNFL, GCL, IPL, and INL. ",
    "Bridging hyperreflective Müller cell columns spanning intraretinal cysts. ",
    "Dome‑shaped serous retinal detachment between neurosensory retina and RPE. ",
    "Elevation and irregularity of the external limiting membrane over fluid collections. ",
    "Drusen manifest as RPE deformations appearing as smooth hyperreflective undulations. ",
    "Hyporeflective wells beneath the RPE layer indicating drusen cores. ",
    "Hyperreflective foci above the RPE representing migratory RPE cells. ",
    "Subretinal drusenoid deposits as granular accumulations between photoreceptors and RPE. ",
    "Serous pigment epithelial detachments appearing as smooth dome‑shaped RPE elevations. ",
    "Hypertransmission zones beneath RPE where geographic atrophy has thinned the RPE. ",
    "Loss of outer retinal bands (ELM and ellipsoid zone) over areas of atrophy. ",
    "Hyperreflective crystalline deposits in the inner retina (crystalline drusen). ",
    "Confluent drusen merging into larger contiguous elevations with high reflectivity. ",
    "Irregular RPE reflectivity with focal thickening indicating early AMD changes. ",
    "Subretinal hyperreflective material above the RPE corresponding to type 2 CNV. ",
    "Hyporeflective network beneath RPE on OCTA representing type 1 neovascularization. ",
    "Fibrovascular PEDs with hyperreflective septa within detached RPE. ",
    "Adjacent subretinal fluid pockets next to CNV lesions in exudative AMD. ",
    "Rippled RPE contours overlying sub‑RPE neovascular tissue. ",
    "Dome‑shaped hyporeflective serous retinal detachment under neurosensory retina. ",
    "Serous pigment epithelial detachments as small convex elevations of RPE. ",
    "Double‑layer sign: split between RPE and Bruch’s membrane seen as two hyperreflective lines. ",
    "Enhanced depth–imaged choroidal thickening under the macula. ",
    "Hyperreflective deposits on the RPE surface indicating fibrin. ",
    "Hyperreflective preretinal membrane adherent to the internal limiting membrane. ",
    "Retinal surface wrinkling with increased inner retinal reflectivity. ",
    "Thickened nerve fiber layer with serrated contour under the membrane. ",
    "Foveal pseudohole showing steep foveal edges without full-thickness defect. ",
    "Globally adherent versus focal attachment points of the membrane on OCT. ",
    "Full-thickness foveal defect with loss of all retinal layers. ",
    "Cuff of subretinal fluid outlining the foveal defect. ",
    "Operculum as hyperreflective tissue above the hole. ",
    "Intraretinal pseudocysts at the edges of a macular hole thickening the rims. ",
    "Bridge‑like hyperreflective vitreous strands connecting to hole edges. ",
    "Foveal elevation with persistent vitreous adhesion causing traction. ",
    "Inner retinal cystoid changes beneath vitreous attachment. ",
    "Acute angle between posterior hyaloid and inner retina on OCT. ",
    "Extended vitreomacular adhesion length measurable between vitreous cortex and retina. ",
    "Thickened central retinal thickness associated with VMT. ",
    "Splitting of retinal layers in retinoschisis appearing as hyporeflective schisis cavities. ",
    "Full‑thickness neurosensory retinal elevation with wavy detached retina in rhegmatogenous RD. ",
    "Round or ovoid hyporeflective spaces with hyperreflective borders (outer retinal tubulations). ",
    "Inner and outer retinal hyporeflective cavities with ILM drape sign in MacTel type 2. ",
    "Hyperreflective inner retinal layers with loss of stratification in acute CRAO. "
    ],
  "normal tissue": [
        "Epithelial tissue: tightly packed cells forming continuous sheets with distinct apical and basal surfaces, lacking blood vessels, and capable of rapid regeneration.",
    "Connective tissue: composed of scattered cells within an abundant extracellular matrix containing collagen, elastin, and reticular fibers.",
    "Skeletal muscle: long, cylindrical, multinucleated fibers with prominent striations arranged in parallel bundles.",
    "Cardiac muscle: branched, striated fibers with centrally located nuclei and intercalated discs facilitating synchronized contractions.",
    "Smooth muscle: spindle-shaped cells with single central nuclei, lacking striations, found in walls of hollow organs.",
    "Nervous tissue: composed of neurons with prominent cell bodies and processes, supported by various types of glial cells.",
    "Adipose tissue: large, round cells with lipid-filled vacuoles displacing the nucleus to the periphery, organized into lobules.",
    "Bone tissue: concentric lamellae forming osteons with central Haversian canals, housing osteocytes in lacunae.",
    "Cartilage: chondrocytes residing in lacunae within a firm, gel-like extracellular matrix, avascular and flexible.",
    "Blood: composed of erythrocytes, leukocytes, and platelets suspended in plasma, facilitating transport and immune responses.",
    "Liver: hepatocytes arranged in plates radiating from central veins, with sinusoids allowing blood flow between them.",
    "Kidney: nephrons with glomeruli and tubules, lined by specialized epithelial cells for filtration and reabsorption.",
    "Lung: alveoli lined by simple squamous epithelium, facilitating gas exchange, with interspersed capillaries.",
    "Skin: stratified squamous keratinized epithelium forming the epidermis, overlying a connective tissue dermis with appendages.",
    "Small intestine: mucosa with villi and microvilli increasing surface area, lined by absorptive and goblet cells.",
    "Colon: mucosa with numerous straight tubular glands (crypts) lined by absorptive and goblet cells, lacking villi.",
    "Stomach: gastric pits leading to glands containing parietal and chief cells, lined by simple columnar epithelium.",
    "Pancreas: exocrine acini producing digestive enzymes, interspersed with endocrine islets of Langerhans secreting hormones.",
    "Spleen: white pulp containing lymphoid follicles, and red pulp with sinusoids and splenic cords filtering blood.",
    "Lymph node: cortex with lymphoid follicles, paracortex rich in T cells, and medulla with cords and sinuses.",
    "Thyroid gland: follicles filled with colloid, lined by cuboidal epithelial cells producing thyroid hormones.",
    "Parathyroid gland: densely packed chief cells secreting parathyroid hormone, with interspersed oxyphil cells.",
    "Adrenal gland: cortex with zona glomerulosa, fasciculata, and reticularis producing steroids; medulla with chromaffin cells secreting catecholamines.",
    "Testis: seminiferous tubules with spermatogenic cells and Sertoli cells, interstitial Leydig cells producing testosterone.",
    "Ovary: cortex with developing follicles at various stages, medulla containing blood vessels and connective tissue.",
    "Uterus (proliferative phase): endometrium with straight glands and dense stroma, myometrium composed of smooth muscle layers.",
    "Uterus (secretory phase): endometrium with coiled glands and edematous stroma, preparing for potential implantation.",
    "Breast: lobules composed of alveoli and ducts lined by epithelial and myoepithelial cells, embedded in fibrous and adipose tissue.",
    "Esophagus: stratified squamous non-keratinized epithelium lining the mucosa, with submucosal glands and muscularis externa.",
    "Trachea: pseudostratified ciliated columnar epithelium with goblet cells, supported by hyaline cartilage rings.",
    "Bronchus: similar to trachea but with smaller diameter, surrounded by smooth muscle and cartilage plates.",
    "Bronchiole: lined by simple ciliated columnar or cuboidal epithelium, lacking cartilage and glands.",
    "Alveolar duct: passages leading to alveolar sacs, lined by simple squamous epithelium facilitating gas exchange.",
    "Tongue: skeletal muscle core covered by stratified squamous epithelium, with specialized papillae housing taste buds.",
    "Salivary gland: acinar cells producing saliva, with ductal system modifying and transporting the secretion.",
    "Gallbladder: mucosa with simple columnar epithelium and microvilli, muscular wall aiding in bile expulsion.",
    "Urinary bladder: transitional epithelium allowing distension, with underlying muscularis for contraction.",
    "Prostate gland: compound tubuloalveolar glands secreting prostatic fluid, surrounded by fibromuscular stroma.",
    "Penis: erectile tissue composed of vascular sinuses, surrounded by connective tissue and covered by skin.",
    "Vagina: stratified squamous non-keratinized epithelium, with underlying lamina propria and muscularis layers.",
    "Cervix: ectocervix lined by stratified squamous epithelium, endocervix by simple columnar epithelium with mucus-secreting glands.",
    "Placenta: chorionic villi with fetal blood vessels, surrounded by syncytiotrophoblast and cytotrophoblast layers.",
    "Umbilical cord: two arteries and one vein embedded in Wharton's jelly, a mucous connective tissue.",
    "Bone marrow: hematopoietic cells at various stages of development interspersed with adipocytes and sinusoids.",
    "Peripheral nerve: bundles of axons surrounded by endoneurium, perineurium, and epineurium connective tissue layers.",
    "Spinal cord: central gray matter with neuronal cell bodies, surrounded by white matter containing myelinated axons.",
    "Cerebellum: cortex with molecular, Purkinje cell, and granular layers, coordinating motor activity.",
    "Cerebral cortex: six distinct layers with varying neuronal types and densities, responsible for higher brain functions.",
    "Retina: layered structure with photoreceptors, bipolar cells, and ganglion cells processing visual information.",
    "Cornea: transparent, avascular tissue with five layers including epithelium, stroma, and endothelium.",
    "Lens: avascular, biconvex structure composed of elongated, transparent fibers enclosed by a capsule.",
    "Inner ear (cochlea): spiral organ of Corti with hair cells detecting sound vibrations, supported by basilar membrane."
    ],
  "metastatic tumor": [
    "Replacement of normal lymph node architecture by irregular malignant glandular structures.",
    "Nests of pleomorphic epithelial cells embedded in a prominent desmoplastic stroma.",
    "Signet ring cells with peripherally displaced nuclei and abundant intracytoplasmic mucin.",
    "Single‑file (Indian file) infiltration of atypical cells characteristic of lobular breast carcinoma metastases.",
    "Well‑formed glandular lumina containing mucin highlighted by mucicarmine stain.",
    "Keratin pearl formation and intercellular bridges typical of squamous cell carcinoma metastases.",
    "Sheets of small round blue cells with high nuclear–cytoplasmic ratio seen in neuroblastoma metastases.",
    "Organ‑oid nesting with “salt‑and‑pepper” chromatin and rosette‑like structures in neuroendocrine tumor metastases.",
    "Pleomorphic spindle cells with frequent mitoses and marked atypia in metastatic sarcoma.",
    "Clear cells in a nested or alveolar pattern indicative of metastatic renal cell carcinoma.",
    "Abundant foamy histiocytes and xanthoma cells surrounding necrotic tumor foci.",
    "Lymphovascular invasion with tumor emboli within vascular channels.",
    "Perineural invasion by tumor cell clusters tracking along nerve sheaths.",
    "Desmoplastic reaction: proliferation of fibroblasts and collagen deposition around tumor cells.",
    "Pagetoid spread of malignant epithelial cells within the epidermis in cutaneous metastases.",
    "Psammoma bodies (concentric calcifications) in metastatic papillary thyroid carcinoma.",
    "Melanin pigment within metastatic melanoma cells staining positive for HMB‑45.",
    "Splintered bone trabeculae with tumor cell infiltration in bone metastases (osteolytic lesions).",
    "Osteoid matrix production by malignant cells in metastatic osteosarcoma.",
    "Sheets of discohesive signet ring cells in Krukenberg tumors of the ovary.",
    "Tumor‑to‑tumor metastasis: two distinct neoplastic cell populations within a single lesion.",
    "Necrotic tumor cell islands with karyorrhexis and ghost outlines.",
    "Palisading tumor cells around central zones of necrosis.",
    "Cribriform glandular architecture seen in metastatic prostate adenocarcinoma.",
    "Intracytoplasmic lumina lined by apical microvilli characteristic of metastatic cholangiocarcinoma.",
    "Prominent clear cell changes with abundant glycogen in metastatic clear cell sarcoma.",
    "Extensive lymph node sinusoidal expansion by metastatic carcinoma cells.",
    "Entrapped benign glands between metastatic tumor nests.",
    "Capsular invasion of lymph node by metastatic tumor cells breaching the capsule.",
    "Solid nests with peripheral palisading in metastatic basal cell carcinoma to skin.",
    "Crystalline eosinophilic hyaline globules within tumor cells (Russell bodies) in metastatic plasmacytoma.",
    "Tumor cell necrosis with “geographic” outlines and surrounding inflammatory infiltrate.",
    "High tumor budding at the invasive front correlating with metastatic potential.",
    "Microacinar proliferation of single cells or small clusters in metastatic lobular carcinoma.",
    "Lymphoid cuffing around metastatic carcinoma deposits in lymphoid organs.",
    "Myxoid stromal changes in metastatic myxoid liposarcoma.",
    "Foci of necrosis forming comedo‑type necrosis in metastatic breast carcinoma.",
    "Intratumoral hemorrhage with hemosiderin‑laden macrophages.",
    "Crystal violet positivity of basement membrane highlights infiltrative growth in metastasis.",
    "Perivascular lymphocyte aggregates in the tumor microenvironment.",
    "Psammomatous calcifications in metastatic serous carcinoma of ovary.",
    "Desmoplastic micropapillary clusters of carcinoma cells in metastatic micropapillary carcinoma.",
    "Tumor cell clusters within efferent lymphatic vessels.",
    "Entrapment of adipocytes between metastatic tumor cell nests in adipose‑rich tissues.",
    "Rosette‑like structures resembling Homer Wright rosettes in metastatic neuroblastoma.",
    "Mallory–Denk bodies within metastatic hepatocellular carcinoma cells.",
    "Cholesterol clefts within necrotic tumor areas in metastatic carcinoma.",
    "Epithelioid granulomas around metastatic carcinoma in lymph nodes.",
    "Intracystic tumor nodules in metastatic ovarian carcinoma to peritoneum.",
    "Subcapsular sinus pattern of tumor cell deposition in lymph node metastasis."
    ],
}

BIOMEDCOOP_TEMPLATES_OLD = {
    "normal brain": [
            "A normal brain in MRI appears with clearly defined structures, no abnormal growths, and symmetrical hemispheres.",
            "The MRI of a normal brain shows intact white and gray matter with no lesions or abnormal signal intensities.",
            "A typical MRI of a normal brain will display normal ventricular size, clear midline structures, and no signs of edema.",
